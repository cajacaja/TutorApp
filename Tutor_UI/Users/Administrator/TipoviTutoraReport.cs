...
{
    public partial class TipoviTutoraReport : Form
    {
        ...
        public TipoviTutoraReport()
        {
            ...
            HttpResponseMessage response = tutorService.GetActionResponse("ReportTitula", parametars);
            if (response.IsSuccessStatusCode)
            {

                var list = response.Content.ReadAsAsync<List<Report_TipoviStudenta_Result>>().Result;
                Report_TipoviStudenta_ResultBindingSource.DataSource = list;
        ...
        private void TipoviTutoraReport_Load(object sender, EventArgs e)
        {
        ...
        private void RefreshBtn_Click(object sender, EventArgs e)
        {
            ...
            string parametars = "";
            if (gradCmb.SelectedValue != null)
            {
                parametars = gradCmb.SelectedValue.ToString()+"/"+datumOd + "/" + datumDo;
            }
            else
            {
                parametars ="0/"+ datumOd + "/" + datumDo ; 
            }
